...
| **formatYearMonth**   | `function`  | `null` | Defines the format for the year-month in the daypicker.|
| **formatYear**   | `function`  | `null` | Defines the format for the year in the monthpicker.|
| **formatYears**   | `function`  | `null` | Defines the format for the years in the yearpicker.|
